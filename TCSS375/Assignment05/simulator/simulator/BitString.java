...
/**
 * A simulator.BitString class represents a series of 1s and 0s and can hold up to
...
public class BitString {
	 ...
	 * sets the length of the simulator.BitString.
	...
	/**
	 * Flips all the bits of the simulator.BitString.
	 */
	public void invert() {
		if (myBits == null) {
	...
	/**
	 * Adds 1 to the simulator.BitString.
	 */
	public void addOne() {
		if (myBits == null) {
			throw new IllegalArgumentException("Bit String must be set first.");
	...
	/**
	 * Displays the simulator.BitString in groups of four or
	 * in one group of 16. 
	 * @param groupsOfFour 
	 */
	...
	/**
	 * Returns a copy of the simulator.BitString
	 * @return copy of simulator.BitString object
	 */
	...
	/**
	 * Returns the unsigned value of the simulator.BitString representation.
	...
	/**
	 * Returns the 2s complement value of the simulator.BitString representation.
	...
	/**
	 * Returns a new simulator.BitString that is the result of appending the parameter
	 * simulator.BitString to th end of the current simulator.BitString.
	 *  
	 * @param other the simulator.BitString to append
	 * @return a new simulator.BitString representing the parameter appended to this simulator.BitString
	 */
	 ...
	 * @param start
	 * @param length
	 * @return A new simulator.BitString is created from the source starting at the
	...
	/**
	 * Returns an array of the bits stored in the simulator.BitString
	...
	/**
	 * Returns the length of the simulator.BitString
	 * @return length
	 */
